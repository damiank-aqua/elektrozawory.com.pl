<?php
$s_title = 'Zawory elektromagnetyczne, do wody, do pary, do powietrza, do oleju, różne średnice przyłącza, producent ode.it | AQUA - Grupa SBS sp. z o.o. | www.elektrozawory.pl';
$s_dirChar = '.';
$s_detailDefault = '';
...
$s_dataProduct = array(
    ...
    '21IH4K1V160-8W' => array('price' => 890.00, 'parameter' => array(
       ...
       'description' => 'Zawór elektromagnetyczny. Stosowany do mediów zgodnych z zastosowną membraną. Ciśnienie minimalne nie jest wymagane. Zastosowane materiały, konstrukcja i  przeprowadzone testy gwarantują niezawodność i długotrwałość wyrobu'),
    ...
    ), 'medium' => 'olej, benzyna, gaz, woda, powietrze, para', 
       'description' => 'Zawór elektromagnetyczny do cieczy 2/2-drożny (drogowy) bezpośredniego działania, normalnie zamknięty. Medium: olej, benzyna, gaz, woda, powietrze, para. Zastosowanie: automatyka przemysłowa, technika ciepłownicza. Stosowany do mediów zgodnych z zastosowną membraną. Ciśnienie minimalne nie jest wymagane. Zastosowane materiały, konstrukcja i  przeprowadzone testy gwarantują niezawodność i długotrwałość wyrobu'),
    ...
    ), 'medium' => '', 'medium' => 'olej, benzyna, gaz, woda, powietrze, para', 
       'description' => 'Zawór elektromagnetyczny do cieczy 2/2-drożny (drogowy) bezpośredniego działania, normalnie zamknięty. Medium: olej, benzyna, gaz, woda, powietrze, para. Zastosowanie: automatyka przemysłowa, technika ciepłownicza. Stosowany do mediów zgodnych z zastosowną membraną. Ciśnienie minimalne nie jest wymagane. Zastosowane materiały, konstrukcja i  przeprowadzone testy gwarantują niezawodność i długotrwałość wyrobu'),
    ...
    '21A5KT55-8W' => array('price' => 220.00, 'parameter' => array(
       ...
       'description' => 'Zawór elektromagnetyczny do cieczy 2/2-drożny (drogowy) bezpośredniego działania, normalnie zamknięty. Medium: olej, gaz, woda, powietrze. Zastosowanie: automatyka przemysłowa, technika ciepłownicza.. Stosowany do mediów zgodnych z zastosowną membraną. Ciśnienie minimalne nie jest wymagane. Zastosowane materiały, konstrukcja i  przeprowadzone testy gwarantują niezawodność i długotrwałość wyrobu'),
    
    '21A5KT55-14W' => array('price' => 300.00, 'parameter' => array(
        0 => 'G 3/8"', 1 => '21A5KT55-14W', 2 => '53', 3 => '~7', 4 => '5,5', 5 => '9', 6 => '14', 7 => '0', 8 => '10', 9 => '5'
    ), 'medium' => '', 'medium' => 'olej, powietrze, gaz, woda', 
       'description' => 'Zawór elektromagnetyczny do cieczy 2/2-drożny (drogowy) bezpośredniego działania, normalnie zamknięty. Medium: olej, gaz, woda, powietrze. Zastosowanie: automatyka przemysłowa, technika ciepłownicza. Stosowany do mediów zgodnych z zastosowną membraną. Ciśnienie minimalne nie jest wymagane. Zastosowane materiały, konstrukcja i  przeprowadzone testy gwarantują niezawodność i długotrwałość wyrobu'),
    ...
    ), 'medium' => 'olej, powietrze, gaz, woda', 
       'description' => 'Zawór elektromagnetyczny do cieczy 2/2-drożny (drogowy) bezpośredniego działania, normalnie zamknięty. Medium: olej, gaz, woda, powietrze. Zastosowanie: automatyka przemysłowa, technika ciepłownicza. Stosowany do mediów zgodnych z zastosowną membraną. Ciśnienie minimalne nie jest wymagane. Zastosowane materiały, konstrukcja i  przeprowadzone testy gwarantują niezawodność i długotrwałość wyrobu'),
    ...
    '21A2KOT-XC' => array('price' => 350.00, 'parameter' => array(
       ...
       'description' => 'Zawór elektromagnetyczny 2/2-drożny (drogowy) bezpośredniego działania, normalnie zamknięty. Medium: woda, powietrze. Zastosowanie: automatyka przemysłowa. Stosowany do mediów zgodnych z zastosowną membraną. Ciśnienie minimalne nie jest wymagane. Zastosowane materiały, konstrukcja i  przeprowadzone testy gwarantują niezawodność i długotrwałość wyrobu'),
