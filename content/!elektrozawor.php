...
echo '<a href="'.$s_page['produkty'].'" class="btn btn-light"><i class="fas fa-angle-double-left fa-2x"></i></a>';

    if(isset($detail)) {
        
        echo '<div class="price-one">'.number_format($s_dataProduct[$detail]['price'], 2, ',', '').' '.$s_currency.'</div>';
        ...
        echo '<div class="row">';
            ...
            echo '<div class="col-xs-12 col-md-6 col-lg-4">';
                ...
                echo '<h1>'.$l_modelElektrozaworu.': '.$detail.'<br>(średnica: '.$par[0].')</h1>';
                
                echo '<a href="product/'.$detail.'/image.jpg" class="image zoom"><img src="product/'.$detail.'/image.jpg" title="'.$detail.'"></a>';
        ...
        echo '<div class="link"><a href="product/'.$detail.'/karta/katalog.pdf" class="btn" target="_blank">'.$l_dokumentacja.'</a></div>';
        ...
        echo '<div class="row">';
            ...
            echo '<div class="col-xs-12">';
                ...
                if(isset($s_dataProduct[$detail]['description'])) {
                    ...
                    echo '<p style="padding: 20px; line-height: 30px;">'.$s_dataProduct[$detail]['description'].'</p>';
        ...
        echo '<div class="modal-button"><a href="produkty,'.$detail.'" class="btn dk-modal" lang="cart">Zamów</a></div>';
